...
################ Setup constants ################
#Thresholds: Yellow
thresh_yellow_low = (0,51,190)
thresh_yellow_high = (40,153,255)
...
def display_line(image, lines):
    ...
    if lines is not None:
        for line in lines:
            ...
            cv2.circle(line_image, (340, 460), 5, [150, 10, 25], 10)
    return line_image
...
def main():
    ...
    while (True):
        ...
        if lines is not None:
            ...
            center_fixed = width/2
            r_x = round(r_x)
            center_fixed = round(center_fixed)

            print(r_slope)

            print("OFF BY {}".format(center_fixed-c1))
