...
class HandCodedLaneFollower(object):
    ...
    def follow_lane(self, frame):
        ...
        yellow_points, blue_points, lane_lines_image, change_in_x_lines = detect_lane(frame) #points = (bottom, middle, top) x values
        ...
        if found_midpoints == 0: #Just go off estimates
            for counter in range(3):
                if yellow_points[counter] is not None:
                    mid_points[counter] = yellow_points[counter] - width/2 #- yellow_goal_points[counter]
